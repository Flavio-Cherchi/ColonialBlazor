...
namespace Colonial.Server.Models
{
    public partial class ColonialDBContext : DbContext
    {
        public ColonialDBContext()
        {
        }

        public ColonialDBContext(DbContextOptions<ColonialDBContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<TAPlayer> TAPlayers { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                var connectionString = builder.Configuration.GetConnectionString("ColonialDBConnection");
                optionsBuilder.UseSqlServer(connectionString);
                //#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                //optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=ColonialDB;Trusted_Connection=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TAPlayer>(entity =>
            {
                entity.HasKey(e => e.IId);

                entity.ToTable("t_a_player", "col");

                entity.Property(e => e.IId).HasColumnName("i_id");

                entity.Property(e => e.IAge).HasColumnName("i_age");
